...
test("should format the value 0.11500000 in unit BNB to 0.11", () => {
    expect(getMinOrderValue(0.11500000, "USDT", "ETH")).toBe(0.11);
});
...
test("should format the value 0.11100000 in unit BNB to 0.11", () => {
    expect(getMinOrderValue(0.11100000, "USDT", "BCC")).toBe(0.11);
});
